...
| Tiêu chí Đánh giá (Metrics) | Kết quả hiện tại (Ngày 26/08/2026) | Kết quả mong muốn |
| :--- | :--- | :--- |
| **Avg CNN Feature Extraction** (ms) | `17.92` ms | Càng thấp càng tốt (< 15ms) |
| **Avg System Throughput** (FPS) | `57.03` FPS | > 30 FPS là đạt chuẩn Real-time |
| **Avg Mamba + Head Time** (ms) | `4.70` ms | Càng thấp càng tốt (< 10ms) |
| **Re-acquisition Latency** (frames) | `39.97` frames | Càng thấp càng tốt (Khóa lại nhanh) |
| **False Alarms (Fine Fails)** | `85412` | Càng thấp càng tốt |
