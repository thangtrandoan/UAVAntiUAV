...
| Tiêu chí Đánh giá (Metrics) | Kết quả hiện tại (Ngày ... ) | Kết quả mong muốn |
| :--- | :--- | :--- |
| **Avg CNN Feature Extraction** (ms) | `[Điền số] ms` | Càng thấp càng tốt (< 15ms) |
| **Avg System Throughput** (FPS) | `[Điền số] FPS` | > 30 FPS là đạt chuẩn Real-time |
| **Avg Mamba + Head Time** (ms) | `[Điền số] ms` | Càng thấp càng tốt (< 10ms) |
| **Re-acquisition Latency** (frames) | `[Điền số] frames` | Càng thấp càng tốt (Khóa lại nhanh) |
| **False Alarms (Fine Fails)** | `[Điền số]` | Càng thấp càng tốt |
